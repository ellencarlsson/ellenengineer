      ...
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-socials">
            <a href="mailto:carlssonellen@live.se" className="footer-social-link" aria-label="Email">
              ...
              <span>carlssonellen@live.se</span>
            </a>
            <a href="https://www.linkedin.com/in/ellen-carlsson-ab04451b4" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="LinkedIn">
