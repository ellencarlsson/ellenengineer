      ...
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-socials">
            <a href="https://github.com/ellencarlsson" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/ellen-carlsson-ab04451b4" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            ...
            <a href="mailto:carlssonellen@live.se" aria-label="Email">
